...
elsif ($player_number == "0" && $cpu_number == "1")||
($player_number == "1" && $cpu_number == "2")||
($player_number == "2" && $cpu_number == "0")
...
elsif ($result_direction == "パターンA上上") || ($result_direction == "パターンA右右") || ($result_direction == "パターンA左左") || ($result_direction == "パターンA下下")
puts "----------------------------------------" 
puts "あなたの負けです"
